...
#+begin_src sh
pacman -S sof-firmware mesa vulkan-radeon linux-cachyos-nvidia-open nvidia-utils  chrony power-profiles-daemon  exfatprogs unrar unzip p7zip zip smartmontools pipewire pipewire-alsa pipewire-pulse pipewire-jack wireplumber alsa-utils bluez bluez-utils lshw usbutils pciutils acpi thermald exfatprogs unrar unzip zip p7zip
#+end_src
